    ...
    while True:
        ...
        if pressed[pygame.K_1]: 
            if isMouseDown and prevX1 != -1 and prevY1 != -1 and currentX1 != -1 and currentY1 != -1:
                ...
                pygame.draw.rect(screen, color,pygame.Rect(r))
        ...
        if pressed[pygame.K_2]: 
            if isMouseDown and prevX1 != -1 and prevY1 != -1 and currentX1 != -1 and currentY1 != -1:
                ...
                pygame.draw.circle(screen, color, c, ra)
        ...
        if pressed[pygame.K_3]:
            if isMouseDown and prevX1 != -1 and prevY1 != -1 and currentX1 != -1 and currentY1 != -1:
                ...
                fill_if_neighbors_not_colored(screen, color, points)
...
def fill_if_neighbors_not_colored(screen, color, points):
    """
    Заливает фигуру указанным цветом, только если её соседи не закрашены.
    """
    filled = set()
    for x, y in points:
        for dx, dy in [(0, 1), (1, 0), (0, -1), (-1, 0)]:
            nx, ny = x + dx, y + dy
            if 0 <= nx < screen.get_width() and 0 <= ny < screen.get_height() and screen.get_at((nx, ny))[:3] == (0, 0, 0):
                filled.add((nx, ny))
